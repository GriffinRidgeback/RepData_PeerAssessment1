...
The highest average number of steps was found in interval **`r x[which.max(x$avg_interval), 1]`** and had the value **`r prettyNum(x[which.max(x$avg_interval), 2])`**.
